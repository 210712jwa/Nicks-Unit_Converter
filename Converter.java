...
public class Converter {
	...
	public static void main(String[] args) {
		...
		while (menuSelection != Quit) {
			...
			System.out.println();
			System.out.println("Place your input here: ");
			...
			case 1:// create a sub menu for volume
				...
				do {
					...
					case 2:
						...
						int tsp1 = sc.nextInt();
						double cups1 = (int) (tsp1 * 0.02083333);
					...
					if (tryAnother.equals("N") || tryAnother.equals("n")) {
						System.out.println("Thank you, powering off!");
						return;
					}
			...
			case 2:// create a sub menu for distance
				...
				break;
			case 3:
				System.out.println("What are the US Gallons you wish to convert?");
